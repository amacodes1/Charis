...
export default function Search() {
  ...
  return (
    <form onSubmit={handleSearchSubmit}>
      <div className="flex flex-row relative ltr ml-8 md:ml-8 lg:ml-2 items-center max-w-xs w-[200px] h-fit bg-transparent border border-black rounded-full cursor-pointer overflow-hidden">
        <svg
          className="search_icon h-6 py-1 px-1 pl-2 fill-stone-50"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
        ...
        <input
          className="inputBox bg-transparent text-gray-800 outline-inherit border-0 w-40 py-2 pr-2 text-sm"
          placeholder="Search products"
          id="inputBox"
          type="text"
          value={searchQuery}
