...
export default function Search() {
  ...
  return (
    <form onSubmit={handleSearchSubmit}>
      <div className="flex flex-row relative ltr ml-8 md:ml-8 lg:ml-16 items-center w-[500px] h-fit bg-black border border-black rounded-full cursor-pointer overflow-hidden">
        <svg
          className="search_icon h-6 py-1 px-1 pl-2 fill-stone-50"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
        ...
        <input
          className="inputBox outline-inherit w-[500px] bg-black border border-black py-2 pr-2 text-sm"
          placeholder="Search products"
          id="inputBox"
          type="text"
          value={searchQuery}
